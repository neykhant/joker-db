...
import { getExpenseName, editExpenseName } from "../../store/actions";
import { useParams } from "react-router-dom";

const { Title } = Typography;

const EditExpenseNames = ({
  status,
  error,
  expenseName,
  getExpenseName,
  ...
  useEffect(() => {
    form.setFieldsValue({ name: expenseName.expenseName.name });
  }, [form, expenseName.expenseName]);

  const onFinish = async (values) => {
    await editExpenseName(param.id, values);
  };
...
export default connect(mapStateToProps, { getExpenseName, editExpenseName })(
  EditExpenseNames
);
