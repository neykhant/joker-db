...
import { createExpenseName } from "../../store/actions";
import { successCreateMessage } from "../../util/messages";

const { Title } = Typography;

const CreateExpenseNames = ({ status, error, createExpenseName }) => {
  ...
  const onFinish = async (values) => {
    await createExpenseName(values);
  };
...
export default connect(mapStateToProps, { createExpenseName })(
  CreateExpenseNames
);
